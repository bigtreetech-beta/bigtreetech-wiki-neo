...
<img src={require('./img/M4P_Size.png').default} width="100%"/>
...
<img src={require('./img/M4P_Pinout.png').default} width="100%"/>
...
<Tabs groupId="m4p-stepper-driver">
    <TabItem value="tmc-uart" label="Uart 模式" default>
        使用 Uart 模式连接驱动
        <img
            src={require('./img/M4P_TMC_UART_Mode.png').default}
            alt="" width="100%"
        />
    </TabItem>
    <TabItem value="tmc-spi" label="SPI 模式">
        使用 SPI 模式连接驱动
        <img
            src={require('./img/M4P_TMC_SPI_Mode.png').default}
            alt="" width="100%"
        />
    </TabItem>
    <TabItem value="step-dir" label="Step / dir 模式">
        A4988 / DRV8825 使用跳线帽短接 MS0-MS2 以调整细分
        <img src={require('./img/M4P_Stepper_Driver.png').default} width="100%"/>
    </TabItem>
</Tabs>

### TMC Sensorless

<img src={require('./img/M4P_TMC_DIAG_Mode.png').default} width="100%"/>
...
<img src={require('./img/M4P_TYPE_C.png').default} width="45%"/>

### 40 Pin GPIO

<img src={require('./img/m4p-40pin-gpio.png').default} width="50%"/>
...
<img src={require('./img/M4P_DSI_CSI_Wiring.png').default} width="100%"/>

### SPI 显示器

<img src={require('./img/M4P_SPI_Display_Wiring.png').default} width="100%"/>

## 传感器

### BLTouch

<img src={require('./img/M4P_BLTouch_Wiring.png').default} width="60%"/>

### ADXL 345

<img src={require('./img/M4P_ADXL345.png').default} width="60%"/>

## 其他硬件

### Neopixel 

<img src={require('./img/M4P_RGB_Wiring.png').default} width="80%"/>
