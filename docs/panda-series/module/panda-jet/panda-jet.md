...
<ImageView src={require('./img/Panda_Jet_Title.webp').default} width="40%" class="right-image"/>
...
<ImageView src={require('./img/Panda_Jet_Packaging.webp').default} width="600"/>
...
<ImageView src={require('./img/Panda_Jet_Installation1.webp').default} width="600"/>

**步骤2：拆下原来的风扇导管**
拧下以下两颗固定原始风扇导管的螺钉。保留螺钉，以便以后重新组装。

<ImageView src={require('./img/Panda_Jet_Installation2.webp').default} width="600"/>
...
<ImageView src={require('./img/Panda_Jet_Installation3.webp').default} width="600"/>

**步骤3：安装Panda Jet**
将Panda Jet与前壳体上的安装孔对齐。

<ImageView src={require('./img/Panda_Jet_Installation4.webp').default} width="600"/>

使用您在步骤2中卸下的两个螺钉固定Panda Jet。

<ImageView src={require('./img/Panda_Jet_Installation5.webp').default} width="600"/>

**步骤4：重新组装前壳体**
将风扇连接器重新连接到板上（最上面的插槽），然后重新连接前壳体部件。

<ImageView src={require('./img/Panda_Jet_Installation6.webp').default} width="600"/>
