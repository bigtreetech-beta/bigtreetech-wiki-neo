...
<ImageView src={require('./img/HDMI5_Title.png').default} width="45%" class="right-image"/>
...
<ImageView src={require('./img/HDMI5_Dimension.png').default} width="80%"/>

## 接口示意图

<ImageView src={require('./img/HDMI5_Interface.png').default} width="80%"/>
...
<ImageView src={require('./img/HDMI5_Audio.png').default} width="80%"/>

### 屏幕亮度调整

BIGTREETECH HDMI5 V1.0 支持亮度调节，可以通过 `Ks1` 按钮增加亮度，通过 `Ks3` 按钮降低亮度。

<ImageView src={require('./img/HDMI5_Brightness.png').default} width="80%"/>

### 显示方向调整

BIGTREETECH HDMI5 V1.0 支持通过 `Ks2` 按钮进行水平显示方向调整。

<ImageView src={require('./img/HDMI5_Direction.png').default} width="80%"/>
...
<ImageView src={require('./img/HDMI5_Desktop.png').default} width="80%"/>
