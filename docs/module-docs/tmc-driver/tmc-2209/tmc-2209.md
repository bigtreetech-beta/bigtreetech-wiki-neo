...
<img
    src={require('./img/TMC2209_Title.png').default}
...
TMC 2209 原理图 [bigtreetech/BIGTREETECH-Stepper-Motor-Driver/TMC2209/Schematic](https://github.com/bigtreetech/BIGTREETECH-Stepper-Motor-Driver/tree/master/TMC2209/V1.1/Schematic)

:::

<img
    src={require('./img/TMC2209_Func.png').default}
    alt="" width="45%"
/>
...
<img
    src={require('./img/TMC2209_Dimension.png').default}
    alt="" width="45%"
/>
...
<img
    src={require('./img/TMC2209_Uart.png').default}
    alt="" width="45%"
/>
...
<img
    src={require('./img/TMC2209_Uart1.png').default}
    alt="" width="80%"
/>
...
<img
    src={require('./img/TMC2209_Mode1.png').default}
    alt="" width="80%"
/>
