...
<img
    src={require('@site/docs/module-docs/tmc-driver/tmc-5160-t-pro/img/tmc-5160-t-pro-title.png').default}
...
<img
    src={require('@site/docs/module-docs/tmc-driver/tmc-5160-t-pro/img/tmc-5160-t-pro-pinout.png').default}
    alt="" width="45%"
/>
...
<img
    src={require('@site/docs/module-docs/tmc-driver/tmc-5160-t-pro/img/tmc-5160-t-pro-size.png').default}
    alt="" width="45%"
/>
