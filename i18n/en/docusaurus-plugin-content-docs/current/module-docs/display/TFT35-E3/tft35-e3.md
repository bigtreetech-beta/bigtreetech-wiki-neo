...
<img src={require('@site/docs/module-docs/display/TFT35-E3/img/TFT35_E3_Title.png').default} width="45%" class="right-image"/>
...
<img src={require('@site/docs/module-docs/display/TFT35-E3/img/TFT35_E3_Diagram.png').default} width="50%"/>
...
<img src={require('@site/docs/module-docs/display/TFT35-E3/img/TFT35_E3_Interface.png').default} width="50%"/>
