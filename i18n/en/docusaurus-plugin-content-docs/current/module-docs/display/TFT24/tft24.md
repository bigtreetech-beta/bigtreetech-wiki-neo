...
<img src={require('@site/docs/module-docs/display/TFT24/img/TFT24_Title.png').default} width="45%" class="right-image"/>
...
<img src={require('@site/docs/module-docs/display/TFT24/img/TFT24_Diagram.png').default} width="50%"/>

## 接口示意图

<img src={require('@site/docs/module-docs/display/TFT24/img/TFT24_Interface.png').default} width="50%"/>
