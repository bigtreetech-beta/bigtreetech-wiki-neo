...
<ImageView src={require('@site/docs/panda-series/module/panda-jet/img/Panda_Jet_Title.webp').default} width="40%" class="right-image"/>
...
<ImageView src={require('@site/docs/panda-series/module/panda-jet/img/Panda_Jet_Packaging.webp').default} width="50%"/>
...
<ImageView src={require('@site/docs/panda-series/module/panda-jet/img/Panda_Jet_Installation1.webp').default} width="50%"/>
...
<ImageView src={require('@site/docs/panda-series/module/panda-jet/img/Panda_Jet_Installation2.webp').default} width="80%"/>
...
<ImageView src={require('@site/docs/panda-series/module/panda-jet/img/Panda_Jet_Installation3.webp').default} width="50%"/>

**Step 3: Install the Panda Jet**
Align the Panda Jet with the mounting holes on the front housing.

<ImageView src={require('@site/docs/panda-series/module/panda-jet/img/Panda_Jet_Installation4.webp').default} width="50%"/>

Secure the Panda Jet using the two screws that you removed in Step 2.

<ImageView src={require('@site/docs/panda-series/module/panda-jet/img/Panda_Jet_Installation5.webp').default} width="80%"/>
...
<ImageView src={require('@site/docs/panda-series/module/panda-jet/img/Panda_Jet_Installation6.webp').default} width="50%"/>
