...
<ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Title.webp').default} width="40%" class="right-image"/>
...
<ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Dimensions.webp').default} width="80%"/>

<ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Dimensions1.webp').default} width="80%"/>

## Interface Introduction

### Interface Diagram

<ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Interface.webp').default} width="80%"/>
...
<ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Installation.webp').default} width="80%"/>
...
<ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation.webp').default} width="80%"/>
...
1. Embed Heat-Set Inserts
    ...
    <ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation1.webp').default} width="60%"/>
    
    <ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation2.webp').default} width="60%"/>

2. Install the Panda Hub

    Place the Panda Hub inside the case.

    <ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation3.webp').default} width="60%"/>

    Place on the top cover and secure it using the M2.5x8 screw and a 2.0mm screwdriver.

    <ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation4.webp').default} width="60%"/>

    <ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation5.webp').default} width="60%"/>

    Connect the Assembled Panda Hub to the Printer. 

    <ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation6.webp').default} width="60%"/>

    Remove the screen and unscrew the screws located below the screen using a 2.0mm hex screwdriver. 

    <ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation7.webp').default} width="60%"/>

    <ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation8.webp').default} width="60%"/>
    ...
    <ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation9.webp').default} width="60%"/>

    Reattach the screen to complete the installation.

    <ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation10.webp').default} width="60%"/>

    Connect the Panda Touch USB Cable or USB Light Strip to the Panda Hub.

    <ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation11.webp').default} width="60%"/>
...
<ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation12.webp').default} width="80%"/>

Place the heat-set insert on top of the 3D printed part, aligned with the cavity designed for it.

<ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation13.webp').default} width="80%"/>
...
<ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation14.webp').default} width="80%"/>
...
<ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation15.webp').default} width="80%"/>

Once the top of the insert is flush with the part, pull the iron back out and let it cool down. 

<ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation16.webp').default} width="80%"/>

Finished! 

<ImageView src={require('@site/docs/panda-series/module/panda-hub/img/Panda_Hub_Preparation17.webp').default} width="80%"/>
