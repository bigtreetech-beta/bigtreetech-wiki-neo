...
<img
    src={require('@site/docs/extruder-docs/nebula/img/nebula_dimensions.png').default}
    alt="nebula" width="60%"
/>
...
<div class="div-table">
    <img
    src={require('@site/docs/extruder-docs/nebula/img/nebula_adjusting.png').default}
...
<div class="div-table">
    <img
        src={require('@site/docs/extruder-docs/nebula/img/nebula_pin.png').default}
...
<div class="div-table">
    <img
        src={require('@site/docs/extruder-docs/nebula/img/nebula_motor.png').default}
        alt="nebula" width="60%" class="right-image"
    />
...
<ThemedImage
    ...
    sources={{
        light: require('@site/docs/extruder-docs/nebula/img/nebula-component-light.png').default,
        dark: require('@site/docs/extruder-docs/nebula/img/nebula-component-dark.png').default,
    }}
/>
