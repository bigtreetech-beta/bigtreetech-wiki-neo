...
<img
    src={require('@site/docs/extruder-docs/h2-v2x/img/H2V2X_Dimension1.png').default}
    alt="h2 v2x" width="60%"
/>

<img
    src={require('@site/docs/extruder-docs/h2-v2x/img/H2V2X_Dimension2.png').default}
    alt="h2 v2x" width="60%"
/>
...
<div class="div-table">
    <img
    src={require('@site/docs/extruder-docs/h2-v2x/img/H2V2X_Filament1.png').default}
...
<img
    src={require('@site/docs/extruder-docs/h2-v2x/img/H2V2X_motor1.png').default}
...
<ThemedImage
    ...
    sources={{
        light: require('@site/docs/extruder-docs/h2-v2x/img/h2-v2x-component-light.png').default,
        dark: require('@site/docs/extruder-docs/h2-v2x/img/h2-v2x-component-dark.png').default,
    }}
/>
