...
<img src={require('@site/docs/accessories-docs/display/TFT35/img/TFT35_V3.0_Title.png').default} width="45%" class="right-image"/>
...
<img src={require('@site/docs/accessories-docs/display/TFT35/img/TFT35_V3.0_Diagram.png').default} width="50%"/>

## 接口示意图

<img src={require('@site/docs/accessories-docs/display/TFT35/img/TFT35_V3.0_Interface.png').default} width="50%"/>
